...
describe('Deck Utility Functions', () => {
  ...
  describe('areSameColor', () => {
    ...
    //  assert.strictEqual(cardUtils.areSameColor(null, SUITS.HEARTS), false, 'Should handle null suitA');
    //  assert.strictEqual(cardUtils.areSameColor(SUITS.HEARTS, undefined), false, 'Should handle undefined suitB');
    //});
  ...
  describe('isRightBower', { concurrency: false }, () => {
    ...
    //  );
    //  
    //  // Should return false for lowercase 'j' since it's not equal to 'J'
    //  assert.strictEqual(
    //    cardUtils.isRightBower({ suit: SUITS.HEARTS, value: 'j' }, SUITS.HEARTS),
    //    false,
    //    'Should return false for lowercase value since it does not match uppercase J'
    //  );
    //  
    //  // Should return false for invalid suit constants instead of throwing
    //  assert.strictEqual(
    //    cardUtils.isRightBower({ suit: 'hearts', value: 'J' }, 'hearts'),
    //    false,
    //    'Should return false for invalid suit constants'
    //  );
    //});
