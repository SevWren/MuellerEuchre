...
export const GameBoard = () => {
  ...
  const renderGamePhase = () => {
    ...
    switch (state.gamePhase) {
      ...
      case "BIDDING":
        ...
        return <GameOverlay title="Waiting for bids..." />;
  ...
  return (
    <div
      className={`game-board phase-${state.gamePhase?.toLowerCase()}`}
      ref={boardRef}
    >
      {/* Score Board */}
      <ScoreBoard
      ...
      <div className="game-area">
        ...
        <div className="opponent-area">
          {Object.entries(state.players || {})
            ...
            .map(([id, player]) => (
              <div
                key={id}
                className={`player-seat ${player.team === 1 ? "team1" : "team2"}`}
              >
        ...
        {/* Center Play Area */}
        <div className="center-area">{renderGamePhase()}</div>
        ...
        <div className="player-area">
          ...
          <div className="player-actions">
            ...
            <button className="btn btn-leave" onClick={leaveGame}>
              Leave Game
            </button>
          </div>
        </div>
