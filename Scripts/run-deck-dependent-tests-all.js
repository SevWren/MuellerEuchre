//run with
//node scripts/run-deck-dependent-tests-all.js
 ...
 * (or 'src/utils/cardUtils.js' after refactoring).
 *
 * This script is designed for regression testing. Whenever 'deck.js' or 'cardUtils.js' is modified,
 * running this script ensures that all directly or indirectly dependent modules continue to function as expected.
 * It executes all unit test files sequentially, logs the full output of any failures
...
// List of unit test files for modules that directly or indirectly depend on 'src/utils/deck.js'
// or 'src/utils/cardUtils.js' (post-refactoring).
const deckDependentTestFiles = [
  // Core Utility Tests (direct dependencies)
  'test/utils/deck.unit.test.js',                   // Tests createDeck, shuffleDeck (post-refactor)
  'test/utils/cardUtils.unit.test.js',              // **NEW**: Tests moved card logic (getCardRank, sortHand, etc.)

  // Game Logic Tests (direct dependencies via validation-core, aiLogic)
  ...
  'test/game/logic/validation.GoAlone.unit.test.js', // validation-core is a dependency for isValidGoAlone

  // Game Phase Tests (direct dependencies via cardToId, getCardRank, createDeck, shuffleDeck)
